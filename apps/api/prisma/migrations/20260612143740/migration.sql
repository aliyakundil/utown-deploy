...
CREATE TABLE `User` (
    ...
    `role` ENUM('CLIENT', 'RESTAURATEUR', 'ADMIN') NOT NULL DEFAULT 'CLIENT',
...
CREATE TABLE `Notification` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `userId` INTEGER NOT NULL,
    `type` ENUM('ORDER_CREATED', 'ORDER_ACCEPTED', 'ORDER_READY', 'ORDER_CANCELLED', 'NEW_RATING', 'SYSTEM') NOT NULL,
